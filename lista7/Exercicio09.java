...
public class Exercicio09 {
	public static void main(String args[]) {
		...
		if(comb==1 && litvend<=20) {System.out.println("Total a Pagar R$:" +totalmenosa);}
		else if (comb==1 && litvend>=20) {System.out.println("Total a Pagar R$:" +totalmaisa);}
		if(comb==2 && litvend<=20) {System.out.println("Total a Pagar R$:" +totalmenosg);}
		else if(comb==2 && litvend>=20) {System.out.println("Total a Pagar R$:" +totalmaisg);}
		sc.close();
	}
