...
public class Exercicio14 {
	public static void main(String args[]) {
		...
		if(mediaaproveitamento>=9) {System.out.println("Conceito A");}
		else if(mediaaproveitamento>=7.5 && mediaaproveitamento<9.0) {System.out.println("Conceito B");}
		if(mediaaproveitamento>=6 && mediaaproveitamento <7.5) {System.out.println("Conceito C");}
		else if(mediaaproveitamento<6) {System.out.println("Conceito D");}
		sc.close();
	}
