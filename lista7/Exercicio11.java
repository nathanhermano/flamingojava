...
public class Exercicio11 {
	public static void main(String args[]) {
		...
		if(kgmorango<=5) {System.out.println("Preço total do Morango:" +somapreco);}
		else if (kgmorango>5) {System.out.println("Preço total do Morango:" +somapreco1);}
		if(kgmaca<=5) {System.out.println("Preço total da Maçã: " +somapreco2);}
		else if(kgmaca>5) {System.out.println("Preço total da Maçã: "+somapreco3);
		if(somafrutas>8) {System.out.println("Valor total da compra: "+descontototal1);}
		else if (totalvalorcd>25.0) {System.out.println("Valor total da compra: "+descontototal1);}
